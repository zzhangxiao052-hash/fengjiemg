...
export default function StatisticsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-slate-900">数据总览</h1>
        <p className="text-slate-500 mt-1">全面了解园区金融与人才各项业务数据</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle>月度人才需求趋势</CardTitle>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={monthlyTalentDemand}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="month" />
                <YAxis />
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="talent" stroke="#82ca9d" name="人才需求" />
              </LineChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
            <CardTitle>月度金融增长</CardTitle>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={monthlyFinancialGrowth}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="month" />
                <YAxis />
                <Tooltip />
                <Legend />
                <Bar dataKey="finance" fill="#8884d8" name="金融增长" />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
