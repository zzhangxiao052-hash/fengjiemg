  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 mt-1">管理商务委管理系统的各项配置</p>
      </div>
          ...
          <Card>
            <CardContent className="space-y-4">
              <div className="space-y-2 mt-4">
                ...
                <Input id="adminAccount" placeholder="请输入新管理员的账号" />
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="unit">申请人所在单位</Label>
                <Input id="unit" placeholder="请输入申请人所在单位" />
              </div>
              <div className="space-y-2">
