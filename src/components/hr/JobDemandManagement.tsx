...
export default function JobDemandManagement() {
  ...
  const demands = [
    { id: '1', company: '科技公司A', position: '软件工程师', experience: '3-5年', salary: '10K-15K', status: '招聘中', publishTime: '2024-10-15' },
    { id: '2', company: '制造公司B', position: '机械工程师', experience: '1-3年', salary: '8K-12K', status: '招聘中', publishTime: '2024-10-14' },
    { id: '3', company: '物流公司C', position: '仓储管理', experience: '5年以上', salary: '6K-9K', status: '已完成', publishTime: '2024-10-13' },
  ];
