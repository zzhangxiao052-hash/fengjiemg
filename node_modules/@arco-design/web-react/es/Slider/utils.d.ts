...
export declare function sortNumberArray(arr: number[]): number[];
export declare function needSort(arr: number[]): boolean;
export declare function findNearestIndex(value: number, array: number[]): [number, number];
