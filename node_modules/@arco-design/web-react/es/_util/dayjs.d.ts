...
export declare function getDayjsValue(time: any, format: string | string[], utcOffset?: number, timezone?: string): originDayjs.Dayjs | originDayjs.Dayjs[];
export declare function getValueWithTime(date: Dayjs, time?: Dayjs): Dayjs;
export declare function getSortedDayjsArray(values?: Dayjs[], fixedTime?: boolean): originDayjs.Dayjs[];
...
export declare function isValidTimeString(str: string, format: string | string[], index?: number): boolean;
