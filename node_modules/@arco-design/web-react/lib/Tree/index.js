...
var node_list_1 = __importDefault(require("./node-list"));
...
var Tree = /** @class */ (function (_super) {
    ...
    function Tree(props, context) {
        ...
        _this.getMergedProps = function (baseProps) {
            ...
            needMergeKeys.forEach(function (key) {
                if (!(0, is_1.isUndefined)(props[key])) {
                    _props[key] = props[key];
                }
                else if (!(0, is_1.isUndefined)(treeComponentConfig[key])) {
        ...
        _this.getTreeData = function () {
            return 'treeData' in _this.props
                ...
                : (0, util_1.getTreeDataFromTreeChildren)(_this.props.children);
        };
        ...
        _this.needUpdateTreeData = function (prevProps, props) {
            ...
            return (prevProps.treeData !== props.treeData ||
                ...
                keys.some(function (key) { return !(0, isEqualWith_1.default)(prevProps[key], props[key]); }));
        };
        ...
        _this.getInitCheckedKeys = function (keys) {
            if (!_this.props.checkStrictly) {
                var _a = (0, util_1.getCheckedKeysByInitKeys)(keys, _this.key2nodeProps), checkedKeys = _a.checkedKeys, indeterminateKeys = _a.indeterminateKeys;
                return {
        ...
        _this.handleCheck = function (checked, key, e) {
            ...
            if (checkStrictly) {
                ...
                if (!(0, is_1.isEmptyObject)(newState)) {
                    _this.setState(__assign({}, newState));
                }
            }
            else {
                // 找到所有允许勾选的子节点
                var _b = (0, util_1.getAllCheckedKeysByCheck)(key, checked, checkedKeys, _this.key2nodeProps, halfCheckedKeys), newCheckedKeys = _b.checkedKeys, indeterminateKeys = _b.indeterminateKeys;
        ...
        _this.getCacheNode = function (key) {
            ...
            return nodeProps.map(function (_props) {
                return __ArcoAdapterMode__ ? ({
                    props: _props,
                    key: key,
                }) : (react_1.default.createElement(node_1.default, __assign({}, _props, { key: _props.key })));
            });
        };
    ...
    Tree.getDerivedStateFromProps = function (nextProps, state) {
        var newState = {};
        if ('selectedKeys' in nextProps && !(0, isEqualWith_1.default)(nextProps.selectedKeys, state.selectedKeys)) {
    ...
    Tree.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (prevProps !== this.props || !(0, isEqualWith_1.default)(prevMergedProps, mergedProps)) {
            var newState_1 = {};
            if (this.needUpdateTreeData(__assign(__assign({}, prevMergedProps), prevProps), __assign(__assign({}, mergedProps), this.props))) {
            ...
            if (newState_1.treeData ||
                ('checkedKeys' in this.props && !(0, isEqualWith_1.default)(prevProps.checkedKeys, this.props.checkedKeys))) {
                ...
                if (!(0, isEqualWith_1.default)(checkedKeys, this.state.checkedKeys)) {
                    newState_1.checkedKeys = checkedKeys;
                }
                if (!(0, isEqualWith_1.default)(halfCheckedKeys, this.state.halfCheckedKeys)) {
                    newState_1.halfCheckedKeys = halfCheckedKeys;
                }
            }
            if (this.props.checkStrictly &&
                'halfCheckedKeys' in this.props &&
                !(0, isEqualWith_1.default)(prevProps.halfCheckedKeys, this.props.halfCheckedKeys)) {
                newState_1.halfCheckedKeys = this.props.halfCheckedKeys;
            }
            if ('expandedKeys' in this.props &&
                !(0, isEqualWith_1.default)(this.props.expandedKeys, prevProps.expandedKeys)) {
    ...
    Tree.prototype.render = function () {
        ...
        return (react_1.default.createElement(context_1.TreeContext.Provider, { value: {
                icons: icons,
                animation: animation,
            ...
            react_1.default.createElement(node_list_1.default, { ref: function (node) {
