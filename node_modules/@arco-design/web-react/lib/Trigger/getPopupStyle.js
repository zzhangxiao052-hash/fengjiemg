...
function getElementPosition(element, elementRect, root, options) {
    ...
    // custom container
    var rootLeft = root === document.body ? 0 : (0, exports.getBoundingClientRect)(root, options).left;
    var rootTop = root === document.body ? 0 : (0, exports.getBoundingClientRect)(root, options).top;
...
var getChildRect = function (child, mouseLocation, _a) {
    ...
    return mouseLocation
        ...
        : (0, exports.getBoundingClientRect)(child, { boundaryDistance: boundaryDistance, position: position });
};
