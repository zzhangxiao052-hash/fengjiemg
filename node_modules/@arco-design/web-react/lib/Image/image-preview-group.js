...
function PreviewGroup(props, ref) {
    ...
    var previewPropsMapRef = (0, react_1.useRef)();
    ...
    function registerPreviewProps(id, previewProps) {
        setPreviewPropsMap(function (pre) { return new Map(pre).set(id, (0, is_1.isObject)(previewProps) ? previewProps : {}); });
    ...
    var handleVisibleChange = function (newVisible, preVisible) {
        var _preVisible = (0, is_1.isUndefined)(preVisible) ? visible : preVisible;
    ...
    var loopImageIndex = function (children) {
        ...
        var loop = function (children) {
            var result = react_1.default.Children.map(children, function (child) {
                if (child && child.props && child.type) {
                    var displayName = child.type.displayName;
                    if (displayName === 'Image') {
                        return react_1.default.cloneElement(child, { _index: index++ });
                    }
                }
            ...
            if (!(0, is_1.isArray)(children) && react_1.default.Children.count(children) === 1) {
                return result[0];
            }
            return result;
        };
    ...
    var renderList = function () {
        ...
        if (array.length > 0) {
            return (react_1.default.createElement("div", { style: { display: 'none' } }, array.map(function (src) { return (react_1.default.createElement("img", { key: src, src: src })); })));
        }
        return null;
    };
