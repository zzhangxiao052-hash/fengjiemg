...
var Message = /** @class */ (function (_super) {
    ...
    Message.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: classNames },
            react_1.default.createElement(react_transition_group_1.TransitionGroup, { component: null }, notices.map(function (notice) { return (react_1.default.createElement(CSSTransition_1.default, { key: notice.id, timeout: transitionTimeout, classNames: transitionClassNames || "fadeMessage", onExit: function (e) {
                    if (!e)
                        return;
