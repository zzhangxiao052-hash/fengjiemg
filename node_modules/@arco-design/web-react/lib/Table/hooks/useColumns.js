...
function useColumns(props) {
    ...
    var baseColumns = (0, react_1.useMemo)(function () { return columns || []; }, [columns]);
    var rows = (0, react_1.useMemo)(function () { return getFlattenColumns(baseColumns, childrenColumnName); }, [baseColumns, childrenColumnName]);
    ...
    var _b = (0, useComponent_1.default)(components), getHeaderComponentOperations = _b.getHeaderComponentOperations, getBodyComponentOperations = _b.getBodyComponentOperations;
    ...
    var rowCount = (0, react_1.useMemo)(function () { return getAllHeaderRowsCount(baseColumns, childrenColumnName); }, [baseColumns, childrenColumnName]);
    // 分行之后的rows
