...
var Picker = function (baseProps, ref) {
    ...
    function onConfirmValue(date, keepOpen) {
        ...
        var sortedValues = (0, dayjs_1.getSortedDayjsArray)(confirmValue, fixedTime);
    ...
    function onSelectPanel(_, date) {
        ...
        var sortedValueShow = (0, dayjs_1.getSortedDayjsArray)(newValueShow, fixedTime);
    ...
    function onSelectValueShow(newValueShow) {
        setValueShow(newValueShow);
        setValueShowHover(undefined);
        var sortedValues = (0, dayjs_1.getSortedDayjsArray)(newValueShow, fixedTime);
...
var PickerComponent = (0, react_1.forwardRef)(Picker);
