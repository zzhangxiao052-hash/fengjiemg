...
function QuarterPicker(props) {
    ...
    return (react_1.default.createElement("div", { className: classNames, style: style },
        react_1.default.createElement(header_1.default, __assign({}, headerOperations, { icons: icons, prefixCls: getPrefixCls('picker'), value: pageShowDate, mode: panelMode, onChangePanel: onChangePanel, DATEPICKER_LOCALE: DATEPICKER_LOCALE, rtl: rtl })),
