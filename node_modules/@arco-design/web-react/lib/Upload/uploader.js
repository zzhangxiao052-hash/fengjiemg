...
var Uploader = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        request = (0, request_1.default)(__assign(__assign({}, options), { action: action, method: method }));
                        return [3 /*break*/, 3];
                    case 1:
    ...
    Uploader.prototype.render = function () {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("input", __assign({ key: "trigger-input", ref: function (node) { return (_this.inputRef = node); }, style: { display: 'none' }, type: "file", accept: (0, is_1.isObject)(accept) ? accept === null || accept === void 0 ? void 0 : accept.type : accept, multiple: multiple }, (directory ? { webkitdirectory: 'true' } : {}), { onChange: function (e) {
            ...
            react_1.default.createElement(CSSTransition_1.default, { key: "trigger-node", in: !hide, timeout: 100, unmountOnExit: true, classNames: "fadeIn" },
