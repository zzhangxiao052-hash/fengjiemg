...
function Statistic(baseProps, ref) {
    ...
    (0, react_1.useImperativeHandle)(ref, function () { return ({
        countUp: countUp,
        getRootDOMNode: function () { return wrapperRef.current; },
    }); });
    ...
    return (react_1.default.createElement("div", __assign({ className: (0, classNames_1.default)("" + prefixCls, (_a = {}, _a[prefixCls + "-rtl"] = rtl, _a), className), style: style }, (0, omit_1.default)(rest, ['value', 'countUp', 'countFrom', 'countDuration']), { ref: wrapperRef }),
