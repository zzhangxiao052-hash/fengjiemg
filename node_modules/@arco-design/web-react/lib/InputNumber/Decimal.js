...
exports.toFixed = exports.getDecimal = void 0;
...
var BigIntDecimal = /** @class */ (function () {
    ...
    BigIntDecimal.prototype.toString = function (options) {
        ...
        var result = safe
            ? this.isInvalid
                ? ''
                : (0, utils_1.trimNumber)("" + this.getMark() + this.getIntegerStr() + "." + this.getDecimalStr()).fullStr
            : this.origin;
...
var NumberDecimal = /** @class */ (function () {
    ...
    NumberDecimal.prototype.add = function (value) {
        ...
        var maxPrecision = Math.max((0, utils_1.getNumberPrecision)(this.number), (0, utils_1.getNumberPrecision)(offset.number));
    ...
    NumberDecimal.prototype.toString = function (options) {
        if (options === void 0) { options = { safe: true }; }
        var safe = options.safe, precision = options.precision;
        var result = safe ? (this.isInvalid ? '' : (0, utils_1.toSafeString)(this.number)) : this.origin;
        return typeof precision === 'number' ? toFixed(result, precision) : result;
    };
    return NumberDecimal;
}());
function getDecimal(value) {
    return (0, utils_1.supportBigInt)() ? new BigIntDecimal(value) : new NumberDecimal(value);
}
 ...
 */
function toFixed(numStr, precision, cutOnly) {
